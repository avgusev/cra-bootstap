...
import { fetchBlock, fetchAccident } from '../api';
...
export class AccidentStore extends DetailedViewStoreImpl {
  constructor() {
    super();
...
const accidentStoreInstance = new AccidentStore();

export default accidentStoreInstance;
