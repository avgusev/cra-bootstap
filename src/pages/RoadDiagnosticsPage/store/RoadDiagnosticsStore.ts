...
import { fetchRoadDiagnostics, fetchBlock } from '../api';
...
export class RoadDiagnosticsStore extends DetailedViewStoreImpl {
  constructor() {
    super();
  ...
  override fetchEntity = (id: number | string) => {
    ...
    fetchRoadDiagnostics(String(id))
...
const roadDiagnosticsStoreInstance = new RoadDiagnosticsStore();

export default roadDiagnosticsStoreInstance;
